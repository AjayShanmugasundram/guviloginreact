  ...
  return (
    <Container maxWidth="sm">
      ...
      <Stack direction="row" spacing={3} sx={{ ml: 1.5 }}>
        <Button variant="contained"><Link to="/AdminLogin"   variant="contained" style={{textDecoration:"none" ,color:"white"}}>Admin Login</Link> </Button>
      ...
      >
        <Stack direction="row" spacing={4} sx={{ ml: 1.5,pt:5.5 }}>
          ...
          <Link to="/Braches" style={{ color: "white" ,textDecoration:"none" }}>
            {" "}
            Branches
          </Link>
        </Stack>
